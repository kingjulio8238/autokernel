...
No-op implementations (for dry-run / CI / testing):
    ...
    NoOpBottleneckAnalyzer, NoOpRAGPrescriber
...
from kernel_agent.platform.nvidia import (
...
from kernel_agent.platform.noop import (
    NoOpBenchmarker,
...
from kernel_agent.platform.registry import PlatformRegistry, registry
