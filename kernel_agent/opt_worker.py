...
from kernel_agent.opt_worker_component.orchestrator.optimization_orchestrator import (
...
class OptimizationWorker:
    ...
    def _init_components(self) -> None:
        ...
        # Benchmarking
        from kernel_agent.opt_worker_component.benchmarking.benchmark import (
            Benchmark,
        )
        ...
        if "profiler" in self._platform:
            ...
            from kernel_agent.opt_worker_component.profiling.kernel_profiler import (
                KernelProfiler,
            )
        ...
        if "bottleneck_analyzer" in self._platform:
            ...
            from kernel_agent.opt_worker_component.prescribing.bottleneck_analyzer import (
                BottleneckAnalyzer,
            )
        ...
        if self.use_rag and "rag_prescriber" in self._platform:
            ...
            try:
                from kernel_agent.opt_worker_component.prescribing.RAG_based_prescriber import (
                    RAGPrescriber,
                )
