...
from kernel_agent.opt_worker_component.searching.history.json_db import (
    JSONProgramDatabase,
)
from kernel_agent.opt_worker_component.searching.history.models import (
    ProgramEntry,
    ProgramMetrics,
)
from kernel_agent.opt_worker_component.searching.strategy.strategy import (
    SearchStrategy,
)
from kernel_agent.opt_worker_component.searching.strategy.beam_search import (
    BeamSearchStrategy,
)
from kernel_agent.opt_worker_component.searching.strategy.greedy import (
    GreedyStrategy,
)
from kernel_agent.ka_utils.config_injectable import config_injectable
...
class OptimizationManager:
    ...
    def _resolve_platform(self, platform: dict[str, str] | str | None) -> None:
        ...
        """
        from kernel_agent.platform.registry import registry
